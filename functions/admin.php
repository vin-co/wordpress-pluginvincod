...
function wp_vincod_load_styles() {
	...
	// Add styles
	$wp_styles->add('vincod', WP_VINCOD_PLUGIN_URL . 'assets/css/admin.css');
	
	// And put enqueue
	$wp_styles->enqueue(array('vincod'));
...
function wp_vincod_load_scripts() {
	...
	// Add scripts
	$wp_scripts->add('vendor', WP_VINCOD_PLUGIN_URL . 'assets/js/vendor.js');
	$wp_scripts->add('api_connection_check', WP_VINCOD_PLUGIN_URL . 'assets/js/api_connection_check.js');
	$wp_scripts->add('dashboard_stuff', WP_VINCOD_PLUGIN_URL . 'assets/js/dashboard_stuff.js');
	
	// And put enqueue
	$wp_scripts->enqueue(array('vendor', 'api_connection_check', 'dashboard_stuff'));
