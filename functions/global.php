...
function wp_vincod_launch($view) {
	 ...
	 *
	 */
	wp_vincod_load_view('admin/header', null, false, WP_VINCOD_PLUGIN_PATH . 'views');
	 ...
	 *
	 */
	wp_vincod_load_view($view, null, false, WP_VINCOD_PLUGIN_PATH . 'views');
	 ...
	 *
	 */
	wp_vincod_load_view('admin/footer', null, false, WP_VINCOD_PLUGIN_PATH . 'views');
