...
<div class="plugin-vincod">
    ...
    <?= wp_vincod_get_menu($parent['vincod']); ?>
                ...
                <div class="blocvin_vintage">
                    ...
                    <? foreach($oldwines as $select_wines): ?>
                            ...
                            <? else: ?>
                            	...
                            	<a href="<?= wp_vincod_link('product', $select_wines['vincod'], $select_wines['name']) ?>"><?= $select_wines['vintageyear'] ?></a>
    ...
    <!-- Widgets -->
            ...
            <div class="blocvin_share">
                ...
                <div class="widgets">
                    <ul>
                        <li><a href="http://vincod.com/<?=$wine['vincod']?>/get/print" target="_blank" title="Fiche techniqe <?=$wine['name']?>"><img src="http://vincod.com/images/picto/24px/pdf-nb.png" /></a></li>
                        <li><a href="http://vincod.com/<?=$wine['vincod']?>/get/tablecard" target="_blank" title="Set de dégustation <?=$wine['name']?> - Vincod"><img src="http://vincod.com/images/picto/24px/set-nb.png" /></a></li>
